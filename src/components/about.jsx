...
export default function About() {
  ...
  return (
    // Safely clears the Navbar with pt-24 while maintaining balanced bottom padding
          ...
          <div className="z-10 flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <div className="relative w-full">
              ...
              <div className="relative mb-6">
                <h2 className="font-cyber bg-gradient-to-r from-orange-400 via-amber-300 to-orange-500 bg-clip-text text-3xl sm:text-4xl lg:text-5xl leading-[1.2] font-black tracking-wide text-transparent drop-shadow-sm">
                  INNOVATING FOR A
                  <br />
                  SUSTAINABLE FUTURE
                </h2>
              ...
              {/* Description - Standardized readable sizes with comfortable line-height */}
              <div className="font-inter space-y-5 text-sm sm:text-base leading-relaxed text-gray-300/90 max-w-xl mx-auto lg:mx-0">
                ...
                {/* THE FIX: Flex-col on mobile (stacking), Flex-row on desktop (side-by-side) */}
                <div 
                ...
                >
                  ...
                  <div className="group relative w-full sm:w-[320px] h-[48px] flex items-center overflow-hidden rounded-lg border border-orange-500/30 bg-neutral-900/80 shadow-[0_0_15px_rgba(249,115,22,0.1)] backdrop-blur-md">
                    ...
                    <div className="relative flex h-full flex-1 items-center px-3 sm:px-4 overflow-hidden">
                      <AnimatePresence mode="popLayout">
                        <motion.div
                          ...
                          // Legible font sizes restored
                          className="font-cyber absolute whitespace-nowrap bg-gradient-to-r from-orange-200 to-amber-400 bg-clip-text text-xs sm:text-sm font-bold tracking-wide text-transparent uppercase drop-shadow-[0_0_8px_rgba(251,146,60,0.3)]"
                        >
                          {sdgGoals[currentSdg]}
                        </motion.div>
                      </AnimatePresence>
