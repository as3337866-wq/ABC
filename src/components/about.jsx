    ...
    <section className="relative overflow-hidden bg-transparent">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 md:py-16 lg:px-8 z-10">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          {/* Right Section - Prize Images with Scroll Fade and Hover Pop */}
          <div className="relative flex min-h-[500px] items-center justify-center sm:min-h-[600px] lg:min-h-[700px]">
            <div className="relative flex w-full max-w-2xl items-end justify-center px-4">
              ...
              {/* 2nd Prize */}
              {/* CHANGED: once is now false so it triggers every time you scroll to it */}
              <motion.div 
                className="relative z-10 -mr-[8vw] mb-6 cursor-pointer"
                custom={0.4}
                initial="hidden"
                whileInView="visible"
              ...
              >
                <Image 
                  ...
                  width={400} 
                  height={500} 
                  className="h-auto w-[28vw] max-w-[280px] min-w-[140px] drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]"
                />
              </motion.div>
              ...
              >
                <Image 
                  ...
                  width={500} 
                  height={600} 
                  className="h-auto w-[35vw] max-w-[360px] min-w-[180px] drop-shadow-[0_20px_50px_rgba(255,140,66,0.4)]"
                />
              </motion.div>

              {/* 3rd Prize - Tilted 5deg */}
              {/* CHANGED: once is now false */}
              <motion.div 
                className="relative z-10 -ml-[8vw] mb-4 cursor-pointer"
              ...
              >
                <div className="rotate-5">
                  <Image 
                    ...
                    width={380} 
                    height={480} 
                    className="h-auto w-[25vw] max-w-[260px] min-w-[120px] drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]"
                  />
                </div>
              </motion.div>
